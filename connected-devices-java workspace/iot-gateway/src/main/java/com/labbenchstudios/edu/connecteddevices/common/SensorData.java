 ...
 * @author khars
 * 
 * SensorData - class defines the SensorData object of Sensor
 *
 */
public class SensorData {
	...
	/**
	 * method to override the previous value stored in the container * 
	 * Getter and setters
	 * 
	 * @param *:  gets the param * and stores it
	 * @return * : returns that param
	 */
